...
from halite.ship.strategy import decide_direction_for_shipyard, attack_target_shipyard
...
class Attacker(RollTemplate):
    ...
    def decide_next_action(self):
        ...
        if self._my_halite > GO_SHIPYARD_WHEN_CARGO_IS_OVER and len(self._ally_shipyard_ids) > 0:
        ...
        if self._my_halite < ATTACK_SHIPYARD_IS_LESS and self._step >= 350:
        ...
        direction = attack_heavy_target_ship2(safe_directions=self._safe_directions, enemy_ship_halites=self._enemy_ship_halites,
