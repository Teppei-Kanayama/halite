...
class RollTemplate:
    ...
    def __init__(self, board, safe_directions: List[str],  safe_directions_without_shipyards: List[str],
                 responsive_area: List[Tuple[int, int]], step: int, my_position: Tuple[int, int], my_halite: int, my_whole_halite: int,
        ...
        self._my_whole_halite = my_whole_halite
        ...
        self._halite_under = halite_under
        self._size = size
